...
public class TowerGele extends Defence implements Runnable {
    ...
    public TowerGele(Position position){
    ...
    public Polygon getForme(){
        ...
        triangle.setFill(Color.LIGHTBLUE); triangle.setStroke(Color.BLACK);
        return triangle;
    }
        ...
        while(true) {
            while (bool) {
                ...
                for (Ennemie ennemie : listenemie) {
                    ...
                    if (ennemie.getHealth() > 0) {ennemie.degel();}
                }
                bool = false;
            }
            try {
