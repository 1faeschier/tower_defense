...
public class TqF_Flaque extends TourQuiFreine implements Shooting, UpdatingS, Payant, Ameliorable, Runnable, AUnePlace {

    //modif les valeurs attributs
    //c'est pas "attack" puisque la tour envoie flaque qui ralentit ou envoie valser plusieurs ennemis en meme temps
    ...
    public TqF_Flaque(Position position){
